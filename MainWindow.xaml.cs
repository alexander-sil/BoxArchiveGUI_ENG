...
namespace BoxArchiveGUI
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void DecompressButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            dialog.Title = "Select Archive for Decompressing";
            dialog.Filter = "BOX Files (*.box)|*.BOX";
            ...
            if (dialog.ShowDialog() == true)
            {
                ...
                MessageBoxResult answer = MessageBox.Show("Show decompressed files?", "", MessageBoxButton.YesNo);
